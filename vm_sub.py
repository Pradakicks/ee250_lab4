...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("adrianth/ipinfo")
    client.subscribe("adrianth/date")
    client.subscribe("adrianth/time")
    
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("adrianth/ipinfo", on_message_from_ipinfo)
    client.message_callback_add("adrianth/date", on_message)
    client.message_callback_add("adrianth/time", on_message)
